...
<section class="pricing">
 ...
 <!-- pricing bacic plan box -->
  ...
  <div class="box">
    ...
    <div class="list">
      ...
      <p><i class="fas fa-check"></i>Underwater Photography</p>
 ...
 <!-- pricing premium plan box -->
  ...
  <div class="box">
    ...
    <div class="list">
      <p><i class="fas fa-check"></i>Action Photography</p>
      <p><i class="fas fa-check"></i>Extreme Sports Photography</p>
      <p><i class="fas fa-check"></i>Underwater Sports Photography</p>
      <p><i class="fas fa-check"></i>Motor Sports Photography</p>
